"""
Take a set of samples and labels, randomly sort and V-fold cross-validate R times
...
class CrossValidation():
	...
	def __init__(self,sample_set,parameters,v,r,test_configurations,stratify=False,root_output=None,target_class=None,output_filename=None):
		self.replicates = []
	...
	def _construct_training_and_testing_sets(self, partitions, set_number):
		...
		test_set = self.sample_set.subset(((local_partitions[set_number],local_partitions[set_number+1]),))
		training_list_list = []
	...
	def get_summary_statistics(self,test_configuration_index):
		...
		summary_statistics = {"mean_f1_score":mean_f1_score,
